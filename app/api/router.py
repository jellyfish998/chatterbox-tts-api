...
from app.api.endpoints import speech, health, models, memory, config, status, voices, long_text, audiobook
...
api_router.include_router(audiobook.base_router, prefix="/v1/audiobook", tags=["Audiobook Studio"])